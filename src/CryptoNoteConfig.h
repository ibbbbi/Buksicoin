...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x16fe1ad0;
...
const char     CRYPTONOTE_NAME[]                             = "Buksicoin";
